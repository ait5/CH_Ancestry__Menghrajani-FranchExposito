...
fun_ch.Gene_by.Ancestry_SPLINE = function(df_ano, DEPENDENT = 'ch.DNMT3A', v_confounders_glm){
  ...
  Glm.test = glm(get(DEPENDENT) ~ order_ancestry + ns(age,3) + Sex + smoking_bin + binary_therapy,
